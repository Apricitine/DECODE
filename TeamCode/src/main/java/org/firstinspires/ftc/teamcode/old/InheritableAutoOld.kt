...
import org.firstinspires.ftc.teamcode.old.ConstantsOld
import org.firstinspires.ftc.teamcode.old.SubsystemsOld
import kotlin.math.PI

abstract class InheritableAutoOld : SubsystemsOld() {
    ...
    override fun init() {
        ...
        robot = ConstantsOld.createFollower(hardwareMap)
        buildPathChains()
