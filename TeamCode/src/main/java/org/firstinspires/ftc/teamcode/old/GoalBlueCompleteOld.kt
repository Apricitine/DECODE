...
import org.firstinspires.ftc.teamcode.pedroPathing.InheritableAutoOld

@Autonomous(name = "Goal Complete Blue Old", group = "main")
open class GoalCompleteBlue : InheritableAutoOld() {
